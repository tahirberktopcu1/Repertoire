...
export default function Navigation() {
  ...
  // Kullanıcının henüz tam oy vermediği şarkı sayısı (beğeni + seyirci tahmini)
  const unratedCount = user ? songs.filter((s) => !votes.some((v) => v.song_id === s.id && v.user_id === user.id && v.value > 0 && v.audience_value != null && v.audience_value > 0)).length : 0
